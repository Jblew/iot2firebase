...
#include "ciotc_config_secrets.h" // Update this file with your secrect (base on ciotc_config_secrets.h.template)
...
void publishTelemetry(char *data)
{
    mqtt->publishTelemetry(data);
}
...
void publishTelemetry(String subfolder, char *data, int length)
{
